...
public class VseDlyaRemontuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Observable<List<Product>> productObservable = productApiRetrofit.getProductsObservableVseDlyaRemontu();
        ...
        productObservable
                ...
                .subscribe((List<Product> s) -> {
                            ...
                            LinearLayoutManager layoutManager = new LinearLayoutManager(VseDlyaRemontuActivity.this);
