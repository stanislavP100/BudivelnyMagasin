...
//import com.example.budivelnymagasin.Activity.SecondActivity.CementActivity;
...
public class BudivelniSumishActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Observable<List<Product>> productObservable = productApiRetrofit.getProductsObservableBudSumishi();
